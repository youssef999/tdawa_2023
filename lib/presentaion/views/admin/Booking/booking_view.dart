...
class AllBookingView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
        create: (BuildContext context) => AdminCubit()..getAllBooking(),
                ...
                body: Container(
                  ...
                  child: ListView(
                    children: [
                      ...
                      AllBookingWidget(cubit.bookingList,cubit),
                    ],
                  ),
                ),
              );
...
Widget AllBookingWidget(List<Booking> listApp, AdminCubit cubit) {
                              ...
                              SizedBox(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Custom_Text(
                                      text: listApp[index].date.toString().replaceAll('00:00:00.000', ''),
                                      color: Colors.grey,
                                      fontSize: 13,
                                      alignment: Alignment.center,
                                    ),
